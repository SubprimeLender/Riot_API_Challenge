...
//convert summoner name into summoner ID
	$parsed_summoner_id = get_api("https://na.api.pvp.net/api/lol/$region/v1.4/summoner/by-name/" . $summoner_name . "?api_key=" . $api_key_1);
	$summoner_id = $parsed_summoner_id->$summoner_name->id;

//get current match data and mastery data for each players in the match
	$parsed_current_match = get_api("https://na.api.pvp.net/observer-mode/rest/consumer/getSpectatorGameInfo/NA1/" . $summoner_id . "?api_key=" . $api_key_1);
